...
const mockReveal = {
  ...
  missedTask: 'Daily Blood Pressure Check',
  secret: '"I once ate an entire pizza and blamed it on my roommate\'s dog. I even scolded the poor dog. Sorry Buddy!"',
  revealedAgo: '2 hours ago',
  likes: 2,
  comments: 3,
  commentList: [
    {
      ...
      time: '1 hour ago',
      text: "Oh no, Michael! That poor dog 😂 But we've all done something similar. Don't worry, we still love you!",
    },
  ],
};

const SecretRevealsPatient = () => {
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.content}>
        <View style={styles.lockCircle}>
          <Ionicons name="lock-closed" size={48} color="#E86D6D" />
        </View>
        <Text style={styles.mainText}>Michael missed a task and a secret was revealed!</Text>
...
const styles = StyleSheet.create({
  ...
  header: {
    backgroundColor: 'rgba(232,109,109,1)',
    paddingTop: 32,
    paddingBottom: 24,
...
export default SecretRevealsPatient; 